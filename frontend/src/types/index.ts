...
export interface TransactionCreate { amount: number; type: TransactionType; category: string; description: string; date: string; source: string | null; person_id: string | null; }
export interface Transaction { id: string; user_id: string; amount: number; type: string; category: string; description: string; date: string; source: string | null; ai_category: string | null; created_at: string; person_id: string | null; person_name: string | null; }
