...
class ImportError(Exception):
    """Raised when the CSV cannot be parsed/extracted into transactions."""


def _build_prompt(csv_text: str, categories: list[str]) -> str:
    hints = "\n".join(
...
def extract_transactions(csv_text: str, categories: list[str]) -> list[dict]:
    """
